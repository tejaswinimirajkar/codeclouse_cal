...
Button(root,text="0",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda:show("0")).place(x=10,y=100)
...
Button(root,text="=",width=11,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#fe9037",command=lambda:cal()).place(x=290,y=500)

Button(root,text="Clear",width=11,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#3697f5",command=lambda:clear()).place(x=10,y=500)
